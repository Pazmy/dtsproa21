def hitung(nama, status, jumlah_tanggungan, gaji):
    ...
    print()
    print("Gaji : ", Gaji)
    print("Premi Jaminan Kecelakaan Kerja : ", Premi_JKK)
    print("Premi Jaminan Kematian : ", Premi_Jaminan_Kematian)
    print("PENGHASILAN BRUTO : ", Ph_Bruto)
    print()
    print("Biaya Jabatan : ", Biaya_Jabatan)
    print("Iuran Pensiun : ", Iuran_pensiun_dbs)
    print("Iuran Jaminan Hari Tua : ", Iuran_JHT_dbs)
    print("PENGURANGAN : ", Biaya_Jabatan + Iuran_pensiun_dbs + Iuran_JHT_dbs)
    print()
    print("PENGHASILAN NETTO SEBULAN = ", Ph_Netto_Sebulan)
    print()
    print("PENGHASILAN NETTO SETAHUN = ", Ph_Netto_Setahun)
    print()
    ...
    Ph_Kena_Pajak_Setahun = round(Ph_Netto_Setahun - PTKP, -3)
    ...
    print("PPh 21 Terutang Setahun : ", PPh21_Setahun)

    PPh21_Sebulan = 1 / 12 * PPh21_Setahun
